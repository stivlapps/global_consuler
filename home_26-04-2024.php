...
if (isset($_REQUEST['submit'])) {
    ...
    $mail->IsHTML(true);
    $mail->AddAddress('sayankolkata.1995@gmail.com');
    ...
    <img src='https://consultingautomatix.com/codes/consolate/admin/upload/logo/1712751640.png' style='width:200px;'>
        ...
        <p style='color: #666;margin-bottom: 20px;'>This email is to inform you that your contact details submmited Confirmed.</p>
