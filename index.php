...
$values = array();
$global_services = $db->query("SELECT * FROM `service_categories` where `is_del`=0 ")->fetchAll();
foreach ($global_services as $global_service) {
    $values[] = $global_service['title'];
}
$value = implode(',', $values);

// $quotes = ['IELTS Exam', 'TOEFL Exam', 'PTE Exam'];
...
if (isset($_REQUEST['submit'])) {
    ...
    <div style='max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1);'>
        ...
        <div style='padding: 5px; text-align: center; color: #777;background-image: url(https://i.ibb.co/n3F4MpC/bg-2.jpg);'>
...
<body>
                                            ...
                                            <div class="wptb-heading">
                                                <div class="wptb-item--inner">
                                                    ...
                                                    <div class="wptb-item--button">
                                                        <a class="btn-readmore style-default" href="#" id='new_services'
                                                            onclick="openModal(event, this, '<?php echo $value ?>')">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="wptb-image-single wow skewIn">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--image">
                                    <img src="admin/upload/about_company/<?php echo $about_company['img'] ?>" alt="img"
                                        class="image-main">
                    ...
                    <div class="col-md-6 mt-5 mt-md-0">
                        <div class="wptb-about-company-one--inner">
                            ...
                            <div class="wptb-item--button">
                                <a href="#" class="btn" id="new_services"
                                    onclick="openModal(event, this, '<?php echo $value ?>')">
                                    <span class="btn-wrap">
            ...
            <div class="container">
                <div class="wptb-heading">
                    <div class="wptb-item--inner text-center">
                        ...
                        <h1 class="wptb-item--title"> <span style='font-size:46px;'>Choose from a Wide Variety of </br>
                                Our
                                Other Services
                            </span></h1>
                    </div>
                ...
                <div class="swiper-container swiper-imagebox">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <?php $services = $db->query("SELECT * FROM `sub_menu` where `is_del`=0  and `mainmenu_id`=4")->fetchAll();
                        foreach ($services as $service) {
                            ...
                            <div class="swiper-slide">
                                <div class="wptb-image-box1 wow fadeInLeft">
                                    <div class="wptb-item--inner">
                                        <a href='sub_menuDetails.php?id=<?php echo $service['id'] ?>'>
                                            <div class="wptb-item--image">
                                                <img src="admin/upload/banner/<?php echo $service['t_img']; ?>" alt="img"
                        ...
                        <div class="wptb-item--right-part">
                            ...
                            <div class="wptb-item--price">
                                ...
                                <div class="wptb-item--button">
                                    ...
                                    <a class="btn--readmore" href="#" id='quote'
                                        onclick="openModal(event, this, 'IELTS Exam')">
                    ...
                    <div class="wptb-item--inner">
                        ...
                        <div class="wptb-item--right-part">
                            ...
                            <div class="wptb-item--price">
                                ...
                                <div class="wptb-item--button">
                                    <a class="btn--readmore" href="#" id='quote'
                                        onclick="openModal(event, this, 'TOEFL Exam')">
                                        <span class="btn-readmore--text"> Ask For Quote </span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="wptb-item--inner">
                        ...
                        <div class="wptb-item--right-part">
                            ...
                            <div class="wptb-item--price">
                                ...
                                <div class="wptb-item--button">
                                    <a class="btn--readmore" href="#" id='quote'
                                        onclick="openModal(event, this, 'PTE Exam')">
                                        <span class="btn-readmore--text"> Ask For Quote </span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="wptb-item--description">Global Consular Service was created to provide
                                uniquely
                                designed premium services in the world of education and migration.
                            ...
                            <div class="swiper-slide">
                                <div class="wptb-partner--image1">
                                    ...
                                    <img src="admin/upload/brand_logo/<?php echo $brand_logo['img']; ?>" alt=""
                                        class="img-fluid" style="border-radius: 75px;">
                                    <img src="admin/upload/brand_logo/<?php echo $brand_logo['img']; ?>" alt=""
                                        style="border-radius: 75px;" class="img-fluid">
    ...
    <script>
        function openModal(event, clickedButton, hiddenInputValues) {
            event.preventDefault();

            var anchorElement = clickedButton.tagName === 'A' ? clickedButton : clickedButton.querySelector('a');
            var idName = anchorElement.getAttribute('id');

            // Check if the anchor element exists and has an ID
            if (idName) {
                console.log("Anchor tag id:", idName);

                if (idName === 'services') {
                    h2Element = document.querySelector('.wptb-item--inner #appointment');
                    h2Element.textContent = "";
                    h2Element.textContent += 'Apply for ' + '  ' + hiddenInputValues;

                    let selectElement = document.querySelector('#selectService');
                    selectElement.innerHTML = '';
                    let newOption = document.createElement('option');
                    newOption.value = hiddenInputValues;
                    newOption.textContent = hiddenInputValues;
                    selectElement.appendChild(newOption);

                    let modal = document.getElementById("myModal");
                    modal.style.display = "block";
                }
                else if (idName === 'new_services') {


                    h2Element = document.querySelector('.wptb-item--inner #appointment');
                    h2Element.textContent = "";
                    h2Element.textContent += 'Book an Appointment';

                    let selectElement = document.querySelector('#selectService');
                    selectElement.innerHTML = '';

                    // Check if hiddenInputValues is defined and not empty
                    let valuesArray = hiddenInputValues.split(',');

                    // Iterate over the array and create an option for each value
                    valuesArray.forEach(function (value) {
                        let newOption = document.createElement('option');
                        newOption.value = value.trim(); // Trim to remove any leading/trailing whitespace
                        newOption.textContent = value.trim(); // Trim to remove any leading/trailing whitespace
                        selectElement.appendChild(newOption);
                    });
                ...
                else if (idName === 'quote') {

                    h2Element = document.querySelector('.wptb-item--inner #appointment');
                    h2Element.textContent = "";
                    h2Element.textContent += 'Book An Appointment for ' + '  ' + hiddenInputValues;
                ...
                console.log("Anchor tag not found or has no ID.");
            }
