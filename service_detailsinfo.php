...
$subMenu = $db->query("SELECT * FROM `visa_list` where `id`=$id")->fetch();
?>
<!DOCTYPE html>
<html lang="zxx">
...
<body>
    ...
    <main class="wrapper">
        <!-- Page Header -->
        <div class="wptb-page-heading" style="background-image: url('admin/upload/banner/1712898565.jpg');">
            <div class="container">
                <div class="wptb-item--inner">
                    <h4 class="wptb-item--title " style='color:white;'><?php echo $subMenu['title'] ?></h4>
        ...
        <section class="wptb-intro-one pb-0">
            <div class="container">
                ...
                <div style='text-align: justify;padding-left:50px;padding-right:50px;color:black;'>
