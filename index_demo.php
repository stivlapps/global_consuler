...
$settings = $db->query("SELECT `phn_no` FROM `settings` ")->fetch();
...
if (isset($_REQUEST['submit'])) {
    ...
    $mail->fromName = 'Global Consular Service';
    $mail->Username = 'hello@2sglobal.co';
    //$mail->Password   = "hyhtddajgbalgemm";
    $mail->Password = "aqkigumonlfsxtef";

    $mail->IsHTML(true);
    $mail->AddAddress($email);
    // $mail->SetFrom("from-hello@2sglobal.co", "2S Global Technologies");
    //$mail->AddReplyTo("reply-to-hello@2sglobal.co", "reply-to-name");
    // $mail->AddCC("cc-recipient-hello@2sglobal.co", "cc-recipient-name");


    $mail->Subject = "Appointment Confirmed for $service";

    $TemplateMessage = "<body style=' font-family: Arial, sans-serif;margin: 0;padding: 0;background-color: #f4f4f4;'><div 
    class='container' style='max-width: 600px;margin: 20px auto;padding: 20px;background-color: #fff;border-radius: 8px;box-shadow: 0 0 10px rgba(0,0,0,0.1);'>
    <img src='https://consultingautomatix.com/codes/consolate/admin/upload/logo/1712751640.png' style='width:200px;'>
        ...
        <ul>
            ...
            <li><strong>Purpose of Visit:</strong> $service</li>
            <li><strong>Date of Application:</strong>" . date('d-m-Y', strtotime($date)) . " " . $time . "</li>
        </ul>
        <p style='color: #666;margin-bottom: 20px;'>Please review the application details and proceed with the necessary actions accordingly.</p>
...
<body>
    <div style="color:black;position: absolute;top:0;opacity:0.8;width:100%;height:100%; z-index:999999999"> </div>
        ...
        <main class="wrapper">
                                            ...
                                            <div class="col-xxl-7 col-lg-6 col-md-10 col-sm-12">
                                                <div class="wptb-heading">
                                                    <div class="wptb-item--inner">
                                                        ...
                                                        <div class="wptb-item--button"> <a
                                                                class="btn-readmore style-default" href="contact_us.php">
                                                                <span class="btn-readmore--text"> Get
                                                                    Started </span> </a></div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <!-- Features Section -->
            <section class="wptb-features-one bg-image"
                style="background-image: url('assets/img/background/bg-6.jpg');">
                <div class="container">
                        ...
                        <div class="wptb-heading d-flex align-items-center justify-content-between flex-wrap">
                            <div class="wptb-item--inner">
                                <h6 class="wptb-item--subtitle text-white">
                                    ...
                                    <?php $feature = $db->query("SELECT * FROM `features`")->fetch(); ?>

                                    Our Features
                                </h6>
                                <h1 class="wptb-item--title text-white" style='font-size:45px;'>
                                    <span><?php echo $feature['title'] ?></span>
                                </h1>
                            </div>

                            <div class="wptb-item--button">
                                <a class="btn-readmore style-default" href="contact_us.php">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="wptb-list1 text-white">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        ...
                                        <div class="wptb-item--text"><?php echo $feature['blog1_title'] ?></div>
                                    </div>
                                    <p><?php echo $feature['blog1_desc'] ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="wptb-list1 text-white">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text"><?php echo $feature['blog2_title'] ?></div>
                                    </div>
                                    <p><?php echo $feature['blog2_desc'] ?></p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="wptb-list1 text-white">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text"><?php echo $feature['blog3_title'] ?></div>
                                    </div>
                                    <p><?php echo $feature['blog3_desc'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner text-center">
                            ...
                            <h1 class="wptb-item--title"> <span style='font-size:46px;'>Choose from a wide variety of
                                    Visa
                                    Services </span></h1>
                        </div>
                    </div>
                            ...
                            foreach ($services as $service) {
                                ...
                                <div class="swiper-slide">
                                    <div class="wptb-image-box1 wow fadeInLeft">
                                        <div class="wptb-item--inner"><a
                                                href='services_details.php?id=<?php echo $service['id']; ?>'>
                                                <div class="wptb-item--image">
                                                    <img src="admin/upload/image_new/<?php echo $service['img']; ?>"
                                                        alt="img">
                                                </div>
                                            </a>
                                            <div class="wptb-item--holder">
                                                ...
                                                <p class="wptb-item--description">
                                                    <?php echo substr(strip_tags($service['description']), 0, 120); ?>...
                                                </p>

                                                <div class="wptb-item--button ">
                                                    <a class="btn--readmore" href="#" id="services"
                                                        onclick="openModal(event,this,'<?php echo $service['title'] ?>')">
                                                        <!-- <input type='hidden' value="VISA SERVICE"> -->
                                                        <span class="btn-readmore--text"> Apply Now</span>
            ...
            <?php $about_company = $db->query("SELECT * FROM `about_company` ")->fetch(); ?>
            <!-- About Company -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="wptb-image-single wow skewIn">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        <img src="admin/upload/about_company/<?php echo $about_company['img'] ?>"
                                            alt="img" class="image-main">
                                            ...
                                            <div class="wptb-icon-box1 wow fadeInLeft">
                                                <div class="wptb-item--inner flex-start">
                                                    ...
                                                    <div class="wptb-item--holder">
                                                        ...
                                                        <p class="wptb-item--description">
                                                            <a
                                                                href="tel:<?php echo $settings['phn_no']; ?>"><?php echo $settings['phn_no']; ?></a>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-6 mt-5 mt-md-0">
                            <div class="wptb-about-company-one--inner">
                                <div class="wptb-heading">
                                    <div class="wptb-item--inner">
                                        ...
                                        <h1 class="wptb-item--title has-line">
                                            <span><?php echo $about_company['title']; ?></span>
                                        </h1>
                                        <p class="wptb-item--description">
                                            Global Consular Service was created to provide uniquely designed premium
                                ...
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Fastest Visa form processing with expert
                                            immigration
                                            agents</div>
                                    </div>
                                    <div class="wptb--item wow skewIn" data-wow-delay="700ms">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">Affiliation with Educational Institutions from over
                                            the
                                            world</div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner text-center">
                            ...
                            <h1 class="wptb-item--title"> <span style='font-size:46px;'>Best partner for seamless
                                    Immigration </br> Experience</span>
                            </h1>
                        </div>
                    </div>
                                            ...
                                            <div class="wptb-item--holder">
                                                ...
                                                <div class="wptb-item--button">
                                                    <a class="btn--readmore" href="#"
                                                        onclick="openModal(event,this,'<?php echo $service['title'] ?>')">
                                                        <!-- <input type='hidden' value="IMMIGRATION SERVICE"> -->
                ...
                <div class="container">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner text-center">
                            ...
                            <h1 class="wptb-item--title"> <span style='font-size:46px;'>Most Trusted Company Formation
                                    </br>Partner Worldwide</span></h1>
                        </div>
                    </div>
                                        ...
                                        <div class="wptb-item--inner">
                                            ...
                                            <div class="wptb-item--holder">
                                                ...
                                                <div class="wptb-item--button">
                                                    <a class="btn--readmore" href="#"
                                                        onclick="openModal(event,this,'<?php echo $service['title'] ?>')">
                                                        <!-- <input type='hidden' value="COMPANY FORMATION SERVICE"> -->
                                                        <span class="btn-readmore--text"> Apply Now</span> <span
                                                            class="btn-readmore--icon"> <i class="bi bi-arrow-right"></i>
                                                        </span>
                                                    </a>
            ...
            <?php $choose_us = $db->query("SELECT * FROM `choose_us`")->fetch(); ?>
            <!-- Why Choose -->
                ...
                <div class="container">
                    <div class="wptb-heading">
                        <div class="wptb-item--inner text-center">
                            ...
                            <h1 class="wptb-item--title" style='font-size:45px;'>
                                <span><?php echo $choose_us['title']; ?></span>
                            </h1>
                        </div>
                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--holder">
                                                <div class="wptb-item--icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="44"
                                                        ...
                                                        <mask id="mask0_46_1597" style="mask-type:luminance"
                                                            ...
                                                            height="44">
                                                            <path d="M40 0.666992H0V43.3337H40V0.666992Z"
                                                                fill="white" />
                                                        </mask>
                                                ...
                                                <h3 class="wptb-item--title"><?php echo $choose_us['blog1_caption']; ?>
                                                </h3>
                                                <p class="wptb-item--description mb-0">
                                                    <?php echo $choose_us['blog1_desc']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--holder">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="42"
                                                        ...
                                                        <g clip-path="url(#clip0_46_1623)">
                                                            ...
                                                            <mask id="mask0_46_1623" style="mask-type:luminance"
                                                                ...
                                                                height="42">
                                                                <path d="M37.8125 0H0.1875V42H37.8125V0Z"
                                                                    fill="white" />
                                                            </mask>
                                                ...
                                                <h3 class="wptb-item--title"><?php echo $choose_us['blog2_caption']; ?>
                                                </h3>
                                                <p class="wptb-item--description mb-0">
                                                    <?php echo $choose_us['blog2_desc']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--holder">
                                                ...
                                                <h3 class="wptb-item--title"><?php echo $choose_us['blog3_caption']; ?>
                                                </h3>
                                                <p class="wptb-item--description mb-0">
                                                    <?php echo $choose_us['blog3_desc']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 wptb-icon-box2 mb-0 p-5 pe-sm-0 pb-sm-0 wow fadeInLeft">
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--holder">
                                                ...
                                                <h3 class="wptb-item--title"><?php echo $choose_us['blog4_caption']; ?>
                                                </h3>
                                                <p class="wptb-item--description mb-0">
                                                    <?php echo $choose_us['blog4_desc']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="wptb-accordion wptb-accordion1 wow fadeInUp">
                                    ...
                                    <?php $faqs = $db->query("SELECT * FROM `faq` where `is_del`=0 ")->fetchAll();
                                    $i = 0;
                                    $p = 1;
                                    foreach ($faqs as $faq) {
                                        ?>
                                        <div class="wptb--item <?php if ($i == 0) { ?> active <?php } ?>">
                                            <h6 class="wptb-item-title">
                                                <span>Q<?php echo $p ?>.<?php echo $faq['question']; ?></span> <i
                                            ...
                                            <div class="wptb-form--wrapper" style='top:55px;'>
                                                <form class="wptb-form" action="" method="post">
                                                    <div class="wptb-form--inner">
                                                        <div class="wptb-heading">
                                                            <div class="wptb-item--inner text-center">
                                                                <h2 class="wptb-item--title" id="appointment"
                                                                    style="font-size: 24px;"> <span>Book An
                                                                        Appointment</span></h2>
                                                            </div>
                                                        </div>
                        ...
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description"> The International English Language Testing System
                                        is
                                        the gold standard for English-language testing that has been trusted by over
                                        12,000
                                        organisations in over 150 countries for more than 30 years. IELTS is globally
                                        accepted by all immigration departments that require an English Language test,
                                        including Australia, Canada, the UK, the USA, Ireland and New Zealand. Global
                                        Consular Services helps individuals to prepare online for the IELTS exam. It
                                        assesses an individual’s ability to Listen, Read, Write, and Speak in English
                                        and is
                                        graded on a band scale of 0-9. The test is conducted in either a computer or
                                        paper-based format. </p>
                                </div>

                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/packages/1.jpg"
                                            alt="img"></a>
                                </div>
                            </div>
                        ...
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description"> Test of English as a Foreign Language TOEFL is a
                                        Standardised Test to measure the English Language ability of non-native speakers
                                        wishing to enroll in English-speaking universities. The test is accepted by more
                                        than 11,000 universities and other institutions in over 190 countries and
                                        territories. TOEFL is one of several major English-language tests worldwide.
                                        Global
                                        Consular Services helps individuals to prepare online for the TOEFL exam.</p>
                                </div>

                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/packages/2.jpg"
                                            alt="img"></a>
                                </div>
                            </div>
                            ...
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">TOEFL Exam Preparation Manual</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">TOEFL Exam Preparation Mock Test</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">TOEFL Preparation Consultation</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">TOEFL Exam Venue & Arrangement</div>
                                    </div>
                                </div>
                        ...
                        <div class="wptb-item--inner">
                            <div class="wptb-item--left-part">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description"> Global Consular Service takes great
                                        pride in its commitment for helping interna
                                        tional students from all over...</p>
                                </div>

                                <div class="wptb-item--image">
                                    <a href="#" class="wptb-item-link"><img src="assets/img/packages/3.jpg"
                                            alt="img"></a>
                                </div>
                            </div>
                            ...
                            <div class="wptb-item--right-part">
                                <div class="wptb-list1">
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">PTE Exam Preparation Manual</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">PTE Exam Preparation Mock Test</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">PTE Preparation Consultation</div>
                                    </div>
                                    <div class="wptb--item wow skewIn animated">
                                        <div class="wptb-item--icon"><i class="bi bi-check"></i></div>
                                        <div class="wptb-item--text">PTE Exam Venue & Arrangement</div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="wptb-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p class="wptb-item--description">Global Consular Service was created to provide
                                    uniquely
                                    des
                    ...
                    <div class="swiper-container swiper-testimonial">
                        ...
                        <?php $testimonial_contents = $db->query("SELECT * FROM `testimonial_content` where `is_del`=0 ORDER BY `sort_order` ASC")->fetchAll(); ?>


                        <div class="swiper-wrapper">
                            <?php foreach ($testimonial_contents as $testimonial_content) { ?>
                                <div class="swiper-slide">
                                    <div class="wptb-testimonial1">
                                        <div class="wptb-item--inner">
                                            <div class="wptb-item--image">
                                                <img src="admin/upload/testimonial/<?php echo $testimonial_content['img']; ?>"
                                                    alt="img">
                                                <div class="wptb-item--icon">
                                            ...
                                            <div class="wptb-item--holder">
                                                <p class="wptb-item--description">
                                                    <?php echo $testimonial_content['content']; ?>
                                                </p>
                                                <div class="wptb-item--meta">
                                                    <div class="wptb-item--meta-left">
                                                        <h4 class="wptb-item--title">
                                                            <?php echo $testimonial_content['name']; ?>
                                                        </h4>
                                                        <h6 class="wptb-item--designation">
                                                            <?php echo $testimonial_content['designation']; ?>
                                                        </h6>
                                                    </div>
                                                    <div class="wptb-item--meta-right">
                                                        <i class="bi bi-star-fill"></i>
                                                        <?php echo $testimonial_content['s_rating']; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    <div class="swiper-container swiper-clients">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <?php $brand_logos = $db->query("SELECT * FROM `brand_logo` where `is_del`=0 ORDER BY `sort_order` ASC")->fetchAll(); ?>

                            <?php foreach ($brand_logos as $brand_logo) { ?>
                                <div class="swiper-slide">
                                    <div class="wptb-partner--image1">
                                        <a href="#">
                                            <img src="admin/upload/brand_logo/<?php echo $brand_logo['img']; ?>" alt=""
                                                class="img-fluid">
                                            <img src="admin/upload/brand_logo/<?php echo $brand_logo['img']; ?>" alt=""
                                                class="img-fluid">
                                        </a>
        ...
        <script>
            ...
            function openModal(event, clickedButton, hiddenInputValue) {
                // Get the modal element
                event.preventDefault();

                // hiddenInputValue = clickedButton.querySelector('input[type=hidden]').value;

                h2Element = document.querySelector('.wptb-item--inner #appointment');
                h2Element.textContent = "";
                h2Element.textContent += 'Apply for ' + '  ' + hiddenInputValue;
                ...
                newOption.value = hiddenInputValue;
                newOption.textContent = hiddenInputValue;
